1:::  funnel card on landing page : 20 aug  ,,,,, 2 option ,,get data from navneet or qlik

4 values , on click qlik page will open,

l1,l2 l3 stages,tcv


taking data from xcalliber
...
ADVANCED USAGE
 ...
 - When Qlik Sense is redirecting to a custom authentication module it passes
  ...
  in javascript , what is the difference ..(let say in function) if i declared variable with
  var or wothout var
